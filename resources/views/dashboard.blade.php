                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    ...
                                    {{-- <h4 class="card-title">{{ \App\Models\Barang::sum('stok') }}</h4> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    ...
                                    {{-- <h4 class="card-title">{{ \App\Models\BarangMasuk::sum('jumlah') }}</h4> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    ...
                                    {{-- <h4 class="card-title">{{ \App\Models\BarangKeluar::sum('jumlah') }}</h4> --}}
                                </div>
                            </div>
                        </div>
                    </div>
